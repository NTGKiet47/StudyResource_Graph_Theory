...
void topo_rankingGraph(Graph g){
	int i, j, u, v, k, rank[MAX], d_in[MAX];
	...
	for(i=1;i<=res_topo.num_list;i++)
		printf("%d ", ele_at_list(res_topo, i));
}
int main(){
